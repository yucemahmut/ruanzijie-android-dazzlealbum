package cn.ancore.dazzlealbum.activity;
...
public class CoverFlowActivity extends Activity implements CoverFlowListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mCoverflow.seCoverFlowtListener(this);
